...
import { punjabiDishes } from '../../data/dummydata';
import {
  DesktopOutlined,
  PieChartOutlined,
...
export default function PunjabFood() {
      ...
      <Layout>
        ...
        <Content style={{ padding: '0 24px' }}>
          <Breadcrumb style={{ margin: '16px 0' }}>
            ...
            <Breadcrumb.Item>Punjab Food</Breadcrumb.Item>
          </Breadcrumb>
          ...
          <div style={{ padding: 24, minHeight: 280, background: '#fff' }}>
            ...
            {/* Product Grid */}
            <Row gutter={[16, 16]}>
              {punjabiDishes.map((product) => (
                <Col
                  xs={24} // 1 col on extra-small screens
                  md={12} // 2 cols on small screens
