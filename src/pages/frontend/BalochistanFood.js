...
import { balochistanDishes } from '../../data/dummydata';
import {
  DesktopOutlined,
  FileOutlined,
  PieChartOutlined,
...
export default function BalochistanFood() {
      ...
      <Layout>
        ...
        <Content style={{ padding: '0 24px' }}>
          <Breadcrumb style={{ margin: '16px 0' }}>
            ...
            <Breadcrumb.Item>Balochistan Food</Breadcrumb.Item>
          </Breadcrumb>
